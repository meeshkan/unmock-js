...
import { includeCodes, changeToConst, responseBody, Arr, changeSingleSchema } from "openapi-refinements";
...
describe("Node.js interceptor", () => {
  describe("with state requests in place", () => {
    ...
    test.skip("t gets correct state after setting state without status code", async () => {
    ...
    test.skip("gets correct state with query parameter when setting textual response", async () => {
